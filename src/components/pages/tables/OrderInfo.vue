    ...
    <div class="row">
      <div class="col-xs-12" style="height:100%">
        <order-info-detail
          ...
          ref="usersInfoDetail"></order-info-detail>
        <order-info-add
          v-show="currentView===2"
          ref="table2add"
          @usersInfoDetailEvent="usersInfoDetailEvent"></order-info-add>
      </div>
    </div>
  </div>
</template>
...
<script>
  import OrderInfoDetail from '@/components/pages/tables/TableComponents/OrderInfoDetail'
  import OrderInfoAdd from '@/components/pages/tables/TableComponents/UsersInfoAdd'
  export default {
    name: "table-test",
    data(){
      return {
