          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="loginName" placeholder="请输入登录名"
                         v-model="table2Form.loginName">
                </div>
              </div>
              <div class="form-group">
                <label for="name" class="col-sm-2 control-label">姓名</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="name" placeholder="请输入姓名" v-model="table2Form.name">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="weixinName" placeholder="请输入微信号"
                         v-model="table2Form.weixinName">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">用户类型</label>
                <div class="col-sm-10">
                  <select class="form-control" v-model="table2Form.roleId">
                    <option v-for="(item,index) in roleName" :value="item.roleId">{{item.roleName}}</option>
                  </select>
                </div>
              </div>
            </div>
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default pull-right" style="margin-right:5px" @click="cancel">取 消</a>
            </div>
            <!-- /.box-footer -->
          </form>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        roleName: [{"roleName": "普通用户", "roleId": "b"}, {"roleName": "管理员", "roleId": "a"}], //所有的用户类型，以后修改为动态
        imageUrl: ''
      }
    },
    methods: {
      ...
      getData() {
        ...
        if (this.$route.params.user != null) {
          this.table2Form = this.$route.params.user;
          // this.table2Form.roleId="b";
        } else {
          this.$router.push({
            'path': '/usersInfo'
          })
      ...
      save() {
        ...
        this.adminUtil.ajaxPutUtil('/user/update/' + this.table2Form.businessId, {
          ...
          password: this.table2Form.password,
          roleId: this.table2Form.roleId
        }, res => {
          if (res.code === 200) {
            loading.close();
            this.$notify.success({
