        ...
        <div class="box" style="height:100%">
          ...
          <div class="box-body" style="height:100%;">
            <div class="box-search form">
              <input type="text" class="form-control" placeholder="按姓名搜索" v-model="searchByName">
              <input type="text" class="form-control" placeholder="按微信号搜索" v-model="searchByWeiXinName">
              <select name="selectBySex" id="selectBySex" class="form-control" v-model="searchBySex">
                <option value="">---按性别搜索---</option>
                <option v-for="item in searchSexOptions" :value="item.sexId">{{item.sexName}}</option>
              </select>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchBySex: '',
        isSearch:false,
        searchSexOptions: [{"sexName": "男", "sexId": "0"}, {"sexName": "女", "sexId": "1"}], //所有的性别
      }
    },
    methods: {
      //获取数据
